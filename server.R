library(readr)
bmi <- read_csv("C:/Users/Nabil Ramlan/Desktop/Sem 4/IDS/Assignment/Shiny apps/bmi.csv")
library(ggplot2)
library(plotrix)
source("./bmi.R")
function(input, output) {
  ...
  output$result2 <- renderText({paste0("Below are BMI data from 200 citizen of United Kingdom")})
